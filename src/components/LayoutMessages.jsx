      ...
      <div className="flex h-full mx-auto max-w-[1300px] overscroll-none">
        <div className="flex flex-1 h-full">
          ...
          <main className="flex flex-3">
            <div
              className="hidden bg-red-100 md:flex flex-col w-[918px] max-w-[988px] lg:min-w-[988px] xl:min-w-[1048px] relative overflow-y-scroll no-scrollbar scrollbar-none"
              ref={mainRef}
